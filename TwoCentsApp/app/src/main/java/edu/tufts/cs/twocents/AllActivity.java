...
public class AllActivity extends AppCompatActivity {
    ...
    private void fetchPolls () {
        FetchPolls my_polls = new FetchPolls();
        my_polls.execute();
    }
    private class FetchPolls extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                URL url = new URL("http://162.243.227.181/api/getPolls?radius=5&lat=2&lng=-2");
